...
if(isset($_GET['status'])){
  if($_GET['status']=='failed'){
    $submitErr = "Must complete all academic and personal information, as well as have a letter of reccomendation and transcript sent!";
  }else  if($_GET['status']=='success'){
    $submitSuccess = "Congratulations! Your application is now under review!";
  }
}
...
<head>
  ...
  <span text-align="center" class="error"><div style="text-align: center;"><?php echo $submitErr;?></span><span class="error"> <?php echo $submitSuccess;?></span></div><br><br>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      if($_SESSION['role']=="applicant"){
        include("applicantMain.php");
      }else if($_SESSION['role']=="faculty"){
        include("facMain.php");
      }else if($_SESSION['role']=="system-admin"){
        include("saMain.php");
      }else if($_SESSION['role']=="gs"){
        include("gsMain.php");
      }else if($_SESSION['role']=="cac"){
        include("cacMain.php");
      }
       ?> 
      <!-- End of Main Content -->
        ...
        <form method="post" action="userDashboard.php">
              <input name="reset" type="submit" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i>Reset DB</input>
            </form>
