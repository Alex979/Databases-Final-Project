      ...
      //need to add letters of recconmendation, and grad committee rating
       ?>
            ...
            <div class="row">
              <!-- Collapsable Card Example -->
              <div class="card shadow mb-4 w-100 p-3"">
                <a href="#appStatus" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="appStatus">
                  <h6 class="m-0 font-weight-bold text-primary">Update Status</h6>
                </a>

                <!-- Card Content - Collapse -->
                <div class="collapse" id="appStatus">
                  <div class="card-body w-100 p-3"">
                  	<div class="row">
                  		<?php
					    ...
					    if(isset($decision)){
					    	echo 'Final Decision: '.$decision.'<br />';
					    }else{
					    	echo '<h6>Final Decision has not yet been made. Cannot update status until a decision is made. </h6><br />';
					    }
