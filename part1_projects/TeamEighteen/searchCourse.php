...
<button class="button" style="vertical-align:middle"><span>Go to Homepage</span></button>
</form>
...
<?php
  ...
  $role = $_SESSION["role"];
	if ($role != "student")
	{
      ...
      $query = "SELECT * FROM courseCatalog WHERE title = '$search' OR dept = '$search' OR courseNumber = '$search'";
