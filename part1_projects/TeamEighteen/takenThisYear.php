...
<?php
	...
	$year = $_POST['year'];
      ...
      echo "<b>Courses from ".$semester." ".$year.": </b><br><br>";
      // define the sql_insert_query
      $query = "SELECT * FROM taken WHERE id = ".$id." AND year = '$year' AND semester = '$semester'";
      ...
      if(mysqli_num_rows($result) > 0){
        ...
        echo "<p>There are no courses taken during ".$semester." ".$year."</p>";    
      }
      //close connection
        mysqli_close($conn);
    ?>
